...
<div class="aspNetHidden">
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
                ...
                <div class="input_field">
                    ...
                    <input name="txtname" type="text" id="txtname" value="122510034" placeholder="User Name" />
                </div>
                <div class="options">
...
window.onload = function () {
    document.getElementById("txtname").value = "122510034";
    document.getElementById("txtPass").value = "20803011215475";
};
